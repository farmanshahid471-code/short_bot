...
if exist "%ROOT%yt_shorts_bot\ffmpeg\bin\ffmpeg.exe" goto :ffmpeg_local_verify
...
:ffmpeg_local_verify
set "FFBIN=%ROOT%yt_shorts_bot\ffmpeg\bin\ffmpeg.exe"
"!FFBIN!" -hide_banner -filters 2>nul | findstr /C:"drawtext" >nul
...
rmdir /S /Q "%ROOT%yt_shorts_bot\ffmpeg" >nul 2>&1
goto :ffmpeg_portable
...
if not exist "%ROOT%yt_shorts_bot\ffmpeg\bin\ffprobe.exe" goto :ffmpeg_manual
set "FFBIN=%ROOT%yt_shorts_bot\ffmpeg\bin\ffmpeg.exe"
"!FFBIN!" -hide_banner -filters 2>nul | findstr /C:"drawtext" >nul
if errorlevel 1 goto :ffmpeg_manual
"!FFBIN!" -hide_banner -filters 2>nul | findstr /C:"subtitles" >nul
